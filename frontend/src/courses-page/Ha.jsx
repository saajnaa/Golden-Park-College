...
const Navigate = useNavigate()
 ...
 return (
     <>
       <div className="main">
         <h2>Diploma In Health Assistance</h2>
 
         <div className="course-intro">This curriculum of Diploma in Health Assistance is of three years duration with six
           semesters based on the semester system.
           Diploma in Health Assistance course of CTEVT is designed to produce middle level
           ...
           Engineering and Industrial Engineering under Health Assistance so as to meet the demand
         ...
         <li>
           ...
           <NavLink className="navlinkDcom" to='/Dcom  '>3. Scholarship for Diploma in Computer Engiennring</NavLink>
